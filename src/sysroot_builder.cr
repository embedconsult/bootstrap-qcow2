      ...
      [
        ...
        PhaseSpec.new(
          BuildPhase.new(
            ...
            namespace: SysrootWorkspace::Namespace::Host.to_s.underscore,
        ...
        PhaseSpec.new(
          BuildPhase.new(
            ...
            namespace: SysrootWorkspace::Namespace::Seed.to_s.underscore,
        ...
        PhaseSpec.new(
          BuildPhase.new(
            ...
            namespace: SysrootWorkspace::Namespace::BQ2.to_s.underscore,
            install_prefix: "/usr",
            destdir: nil,
            env: bq2_phase_env,
          ),
