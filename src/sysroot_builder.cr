...
module Bootstrap
  ...
  class SysrootBuilder
      ...
      [
        ...
        PhaseSpec.new(
          ...
          extra_steps: [
            ...
            BuildStep.new(
              name: "remove-rootfs-docs",
              strategy: "remove-tree",
              workdir: "/",
              configure_flags: [] of String,
              patches: [] of String,
              install_prefix: "/usr/share/doc",
            ),
            BuildStep.new(
              name: "remove-rootfs-manpages",
              strategy: "remove-tree",
              workdir: "/",
              configure_flags: [] of String,
              patches: [] of String,
              install_prefix: "/usr/share/man",
            ),
            BuildStep.new(
              name: "remove-rootfs-infopages",
              strategy: "remove-tree",
              workdir: "/",
              configure_flags: [] of String,
              patches: [] of String,
              install_prefix: "/usr/share/info",
            ),
            BuildStep.new(
              name: "remove-rootfs-help",
              strategy: "remove-tree",
              workdir: "/",
              configure_flags: [] of String,
              patches: [] of String,
              install_prefix: "/usr/share/help",
            ),
            BuildStep.new(
              name: "remove-rootfs-gtk-doc",
              strategy: "remove-tree",
              workdir: "/",
              configure_flags: [] of String,
              patches: [] of String,
              install_prefix: "/usr/share/gtk-doc",
            ),
            BuildStep.new(
              name: "remove-cmake-help",
              strategy: "remove-tree",
              workdir: "/",
              configure_flags: [] of String,
              patches: [] of String,
              install_prefix: "/usr/share/cmake-#{DEFAULT_CMAKE}/Help",
            ),
            BuildStep.new(
              name: "remove-llvm-extras",
              strategy: "remove-paths",
              workdir: "/",
              configure_flags: [] of String,
              patches: [] of String,
              # Keep only the LLVM tools referenced by the build plan and
              # profile defaults: clang/clang++/clang-cpp, lld/ld.lld, and
              # llvm-{ar,nm,ranlib,strip,config}.
              env: {
                "PATH_0"  => "/usr/bin/bugpoint",
                "PATH_1"  => "/usr/bin/c-index-test",
                "PATH_2"  => "/usr/bin/clang-apply-replacements",
                "PATH_3"  => "/usr/bin/clang-check",
                "PATH_4"  => "/usr/bin/clang-doc",
                "PATH_5"  => "/usr/bin/clang-extdef-mapping",
                "PATH_6"  => "/usr/bin/clang-format",
                "PATH_7"  => "/usr/bin/clang-format-diff",
                "PATH_8"  => "/usr/bin/clang-include-fixer",
                "PATH_9"  => "/usr/bin/clang-move",
                "PATH_10" => "/usr/bin/clang-offload-bundler",
                "PATH_11" => "/usr/bin/clang-offload-packager",
                "PATH_12" => "/usr/bin/clang-query",
                "PATH_13" => "/usr/bin/clang-refactor",
                "PATH_14" => "/usr/bin/clang-rename",
                "PATH_15" => "/usr/bin/clang-repl",
                "PATH_16" => "/usr/bin/clang-scan-deps",
                "PATH_17" => "/usr/bin/clang-tidy",
                "PATH_18" => "/usr/bin/clangd",
                "PATH_19" => "/usr/bin/diagtool",
                "PATH_20" => "/usr/bin/llvm-addr2line",
                "PATH_21" => "/usr/bin/llvm-as",
                "PATH_22" => "/usr/bin/llvm-bcanalyzer",
                "PATH_23" => "/usr/bin/llvm-bitcode-strip",
                "PATH_24" => "/usr/bin/llvm-cat",
                "PATH_25" => "/usr/bin/llvm-cfi-verify",
                "PATH_26" => "/usr/bin/llvm-cov",
                "PATH_27" => "/usr/bin/llvm-cvtres",
                "PATH_28" => "/usr/bin/llvm-cxxdump",
                "PATH_29" => "/usr/bin/llvm-cxxfilt",
                "PATH_30" => "/usr/bin/llvm-cxxmap",
                "PATH_31" => "/usr/bin/llvm-debuginfo-analyzer",
                "PATH_32" => "/usr/bin/llvm-debuginfod",
                "PATH_33" => "/usr/bin/llvm-debuginfod-find",
                "PATH_34" => "/usr/bin/llvm-diff",
                "PATH_35" => "/usr/bin/llvm-dis",
                "PATH_36" => "/usr/bin/llvm-dlltool",
                "PATH_37" => "/usr/bin/llvm-dwarfdump",
                "PATH_38" => "/usr/bin/llvm-dwp",
                "PATH_39" => "/usr/bin/llvm-exegesis",
                "PATH_40" => "/usr/bin/llvm-extract",
                "PATH_41" => "/usr/bin/llvm-gsymutil",
                "PATH_42" => "/usr/bin/llvm-ifs",
                "PATH_43" => "/usr/bin/llvm-jitlink",
                "PATH_44" => "/usr/bin/llvm-jitlink-executor",
                "PATH_45" => "/usr/bin/llvm-lib",
                "PATH_46" => "/usr/bin/llvm-link",
                "PATH_47" => "/usr/bin/llvm-lipo",
                "PATH_48" => "/usr/bin/llvm-lto",
                "PATH_49" => "/usr/bin/llvm-lto2",
                "PATH_50" => "/usr/bin/llvm-mc",
                "PATH_51" => "/usr/bin/llvm-mca",
                "PATH_52" => "/usr/bin/llvm-ml",
                "PATH_53" => "/usr/bin/llvm-modextract",
                "PATH_54" => "/usr/bin/llvm-mt",
                "PATH_55" => "/usr/bin/llvm-nm-test",
                "PATH_56" => "/usr/bin/llvm-objcopy",
                "PATH_57" => "/usr/bin/llvm-objdump",
                "PATH_58" => "/usr/bin/llvm-opt-report",
                "PATH_59" => "/usr/bin/llvm-pdbutil",
                "PATH_60" => "/usr/bin/llvm-profdata",
                "PATH_61" => "/usr/bin/llvm-profgen",
                "PATH_62" => "/usr/bin/llvm-rc",
                "PATH_63" => "/usr/bin/llvm-readelf",
                "PATH_64" => "/usr/bin/llvm-readobj",
                "PATH_65" => "/usr/bin/llvm-reduce",
                "PATH_66" => "/usr/bin/llvm-remarkutil",
                "PATH_67" => "/usr/bin/llvm-rtdyld",
                "PATH_68" => "/usr/bin/llvm-sim",
                "PATH_69" => "/usr/bin/llvm-size",
                "PATH_70" => "/usr/bin/llvm-split",
                "PATH_71" => "/usr/bin/llvm-stress",
                "PATH_72" => "/usr/bin/llvm-strings",
                "PATH_73" => "/usr/bin/llvm-symbolizer",
                "PATH_74" => "/usr/bin/llvm-tapi-diff",
                "PATH_75" => "/usr/bin/llvm-tblgen",
                "PATH_76" => "/usr/bin/llvm-tli-checker",
                "PATH_77" => "/usr/bin/llvm-undname",
                "PATH_78" => "/usr/bin/llvm-xray",
                "PATH_79" => "/usr/bin/llvm-yaml2obj",
              },
            ),
            BuildStep.new(
              name: "clean-rootfs-tmp",
              strategy: "clean-dir",
              workdir: "/",
              configure_flags: [] of String,
              patches: [] of String,
    ...
    #
    # The bundle is sourced from the Let's Encrypt ISRG Root X1 certificate
